...
3. `docs/rules/<ruleId>.md` を [docs/rules/genji-out-of-dict.md](./rules/genji-out-of-dict.md) のテンプレートに
   従って作成する（**ルールごとに1ファイル**）。
...
- `docs/rules/` のファイル名は `ruleId` と一致させる（例 `genji-out-of-dict` → `docs/rules/genji-out-of-dict.md`）。
